...
- (void)updateLocationToServer {
    ...
    PFGeoPoint *point = [PFGeoPoint geoPointWithLatitude:self.myLocation.latitude longitude:self.myLocation.longitude];
   
    
    PFInstallation *currentInstallation = [PFInstallation currentInstallation];
    [currentInstallation setObject:point forKey:@"location"];
